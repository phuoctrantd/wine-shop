                  ...
                  <aside className="blog-detail__sidebar">
                    ...
                    <div className="blog-detail__video">
                      ...
                      <div className="video">
                        ...
                        >
                          <span>
                            <em className="fas fa-play-circle" />
                          </span>
                          <span className="border-animation border-animation--border-inner" />
                          <span className="border-animation border-animation--border-outter" />
                        </a>
                      </div>
                    </div>
                  </aside>
